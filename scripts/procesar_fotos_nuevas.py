...
def procesar_foto(foto_path, datos_json):
    ...
    url_completa = f"https://raw.githubusercontent.com/franciscotomatis/APP-CBA-2027/main/fotos_imagenes/full/{nombre_jpg}"
    url_miniatura = f"https://raw.githubusercontent.com/franciscotomatis/APP-CBA-2027/main/fotos_imagenes/thumb/{nombre_jpg}"
